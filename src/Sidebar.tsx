  ...
  return (
    <div className="flex">
      ...
      <div className=" bg-gray-100 min-h-screen flex-1">
          ...
          <table className="border w-full">
            ...
            <tbody className="text-left">
              <tr className="cursor-pointer text-gray-700 border-y">
                ...
                <td>6300</td>
                <td>0</td>
                <td><p className="bg-green-100 text-green-600 w-[40%] text-center rounded-md">paid</p></td>
              ...
              <tr className="cursor-pointer text-gray-700">
                ...
                <td>6300</td>
                <td>0</td>
                <td><p className="bg-red-100 text-red-600 w-[40%] text-center rounded-md">unpaid</p></td>
                <td><FaEllipsisVertical /></td>
              </tr>
            </tbody>
          </table>
        ...
        <Modal open={open} body={<p>Type here</p>} />
      </div>
    </div>
  );
};
